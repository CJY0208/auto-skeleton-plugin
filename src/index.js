...
const generateSkeleton = require('./generateSkeleton')

function AutoSkeletonPlugin(...args) {
  ...
  this._options.generateSkeleton =
    this._options.generateSkeleton || generateSkeleton
  this._options.renderer =
    this._options.renderer ||
    new JSDOMPrerenderer({
      renderAfterTimeout: 5000,
      renderAfterDocumentEvent: 'prerender-ready',
      useResourceCache: false,
      generateSkeleton: this._options.generateSkeleton,
      inject: {
        __PR__: true,
      },
    })
...
AutoSkeletonPlugin.prototype.apply = function (compiler) {
  ...
  if (compiler.hooks) {
    const plugin = { name: 'AutoSkeletonPlugin' }
...
AutoSkeletonPlugin.generateSkeleton = generateSkeleton

module.exports = AutoSkeletonPlugin
